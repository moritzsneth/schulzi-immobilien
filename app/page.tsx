...
export default function Home() {
  ...
  // Headline entrance + nav scrolled state + reveal observer
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* ═══════ Hero ═══════ */}
      <header id="top" className="hero-wrap" data-screen-label="01 Hero">
        <div className="hero-sticky">
          <div className="hero-stage">
            <figure className="hero-art" id="heroArt" tabIndex={0} aria-label="Vom Entwurf zum fertigen Haus — zum Ansehen berühren">
              <img className="hero-img blueprint" src="/images/house-blueprint.png" alt="Architektonischer Entwurf des Hauses" />
              <img className="hero-img final" src="/images/house-final.png" alt="Fertiggestelltes Haus" />
          ...
          <div className="hero-overlay">
            ...
            <div>
              ...
              <div className="hero-bottom" style={{ marginTop: 48 }}>
                ...
                <div className="hero-swap" aria-hidden="true">
                  <span className="hero-hint">
                    <span className="ic">↗</span> Über das Haus fahren
                  </span>
                  <div className="hero-swap-state">
                    <span className="s-sketch">
                      <span className="num">— Entwurf</span>
                      <span className="name serif">Skizze</span>
                    </span>
                    <span className="s-home">
                      <span className="num">— Fertiggestellt</span>
                      <span className="name serif">Zuhause</span>
                    </span>
                  </div>
                </div>
              </div>
